<?php
 ...
 if(isset($_POST['but_upload'])){
  ...
  if(mysqli_num_rows($viewresult)>0){
      echo '<script>alert("Slide Show Alrady Addedd. You can Only Change Image"); window.location.href="dashboard.php?id=20";</script>';
  }else{
      ...
      if( in_array($imageFileType,$extensions_arr) ){
        if( in_array($imageFileType1,$extensions_arr) ){
          if( in_array($imageFileType2,$extensions_arr) ){
                 ...
                 $query = "INSERT into slider_banner(slider_banner_01,slider_banner_02,slider_banner_03) values('".$name."','".$name1."','".$name2."')";
                 ...
                 move_uploaded_file($_FILES['file2']['tmp_name'],$target_dir.$name2);
                  ...
                  echo '<script>alert("Slide Show Inserted Success"); window.location.href="dashboard.php?id=20";</script>';
  ...
  <body class="a bg-light">
    <div class="container-fluid ">
      <div class="row p-3" style="border-bottom: 3px solid black; background-color: #00394e">
        <div class="col-md-3 ">
          <h3 class=""><a class="text-light" style="text-decoration: none;" href="dashboard.php?id=20"><b><i class="fas fa-arrow-left mr-3"></i></b></a></h3>

        </div>
        <div class="col-md-9 ">
          <h3 class=""><a class="text-warning" style="text-decoration: none; float: right; font-size: 30px;" href="dashboard.php"><b>GIGABYETE Slide Manager </b></a></h3>
        </div>
      </div>
    </div><!-- Nav Bar End -->

    <h3 class=""><a class="text-info ml-5" style="text-decoration: none; float: left; font-size: 30px;" href="image_upload.php"><b>Add Image Slider </b></a></h3>
