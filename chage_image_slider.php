<?php
 ...
 if(isset($_POST['but_upload'])){
  ...
  if( in_array($imageFileType,$extensions_arr) ){
      ...
      echo '<script>alert("Slide Show Image Change Success"); window.location.href="dashboard.php?id=20";</script>';
  }
  ...
  <body class="a bg-light">
    <div class="container-fluid ">
      <div class="row p-3" style="border-bottom: 3px solid black; background-color: #00394e">
        ...
        <div class="col-md-9 ">
          <h3 class=""><a class="text-warning" style="text-decoration: none; float: right; font-size: 30px;" href="dashboard.php"><b>GIGABYETE Slider Manager </b></a></h3>
        </div>
      </div>
    </div><!-- Nav Bar End -->

    <h3 class=""><a class="text-info ml-5" style="text-decoration: none; float: left; font-size: 30px;" href="chage_image_slider.php"><b>Chang Images Slider </b></a></h3>
  <div id="content"><br>
