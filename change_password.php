            ...
            <h1 class='text-light'>GIGABYTE Edit Profile</h1>
              <div class="form-login"></br>
                <form action="" method="POST"> 
                    ...
                    <div class="wrapper">
                        <button style="font-size: 20px; padding-bottom: 7%;" class="but_01 col-8 input-sm btn-danger" type="submit" name="submit"><b>Change Password<i class="fa fa-sign-in"></i></b></button><br><br>
