<?php
  ...
  if(mysqli_num_rows($viewresult) <= 0){
    ...
    echo '<script>alert("Please Add Image Galary First"); window.location.href="product_view.php";</script>';
  }
...
<head>
  ...
  <body class="a bg-light">
    ...
    <h3 class=""><a class="text-info ml-5" style="text-decoration: none; float: left; font-size: 30px;" href="galary_change_images.php?pid=<?php echo $id; ?>"><b>Add Product Galary </b></a></h3>

  <div id="content"><br>
  <form method="post" action="" style="padding: 3%;" enctype='multipart/form-data'>
    <p style="font-size: 20px; color: red">Galary Image 01</p>
    <input type='file' name='file1' /><br>

    <p style="font-size: 20px; color: red">Galary Image 02</p>
    <input type='file' name='file2' /><br>

    <p style="font-size: 20px; color: red">Galary Image 03</p>
    <input type='file' name='file3' /><br>

    <p style="font-size: 20px; color: red">Galary Image 04</p>
    <input type='file' name='file4' /><br>

    <p style="font-size: 20px; color: red">Galary Image 05</p>
    <input type='file' name='file5' /><br>

    <p style="font-size: 20px; color: red">Galary Image 06</p>
