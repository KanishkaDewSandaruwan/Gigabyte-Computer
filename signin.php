...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-4 p-5 col-md-4 text-center">
            <h1 class='text-light'>GIGABYTE Sign In</h1>
              <div class="form-login"></br>
              	<form action="" method="POST">	
	                ...
	                <div class="wrapper">
	                	<button style="font-size: 20px; padding-bottom: 10%;" class="but_01 col-8 input-sm btn-danger" type="submit" name="submit"><b>Log In <i class="fa fa-sign-in"></i></b></button><br><br>
	                </div>
              	</form>
            </div>
        </div>
