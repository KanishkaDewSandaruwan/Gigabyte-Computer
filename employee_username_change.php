...
<form class="edit_page" action="" method="POST" style="padding: 3%; font-family: \"Times New Roman\",Times, serif;">
...
<?php
	if(isset($_POST['sign_sub']))
	{
		...
		if(!empty($uname))
		{
			$query1="SELECT * FROM employee WHERE username='$uname'";
			$sql1=mysqli_query($con,$query1);
				...
				else
				{
					...
					else
					{
						...
						$query3="UPDATE employee SET username='$uname' WHERE username='".$g."'";
